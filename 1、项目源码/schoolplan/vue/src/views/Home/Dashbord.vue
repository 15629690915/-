  ...
  <div class="home-container">
    ...
    <header>
      <div class="header-back">
        <div>
          <img class="img" src="@/assets/home_back.png" alt="" @click="$router.push('./Pics')">
        </div>
      ...
      <div class="right">
        <div>
          <p :class="{'active': active === 2}" @click="handleChangeType(2)">地域分析</p>
          <p :class="{'active': active === 1}" @click="handleChangeType(1)">学科分析</p>
        </div>
    ...
    <div ref="popover" class="city-popover">
      ...
      <div>
        ...
        <div>
          <p>211学校数量 &nbsp; {{bubbleData.iotDoorControlCount}}</p>
          <p>985学校数量 &nbsp; {{bubbleData.communityCount}}</p>
        </div>
      </div>
    </div>
  </div>
